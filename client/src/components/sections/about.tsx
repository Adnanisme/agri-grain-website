...
import aboutImage from "@assets/stock_images/modern_grain_silo_st_cf2a08c7.jpg";
...
export function About() {
  ...
  return (
    <section id="about" className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#E8F3D6] rounded-full blur-[120px] opacity-60 -translate-y-1/2 translate-x-1/2 -z-10" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#FAF1E6] rounded-full blur-[100px] opacity-70 translate-y-1/3 -translate-x-1/3 -z-10" />
            ...
            <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl aspect-[4/5] border-8 border-white">
              ...
              <div className="absolute bottom-10 left-10 right-10 text-white">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-secondary font-bold tracking-wider uppercase text-xs">Our Commitment</span>
                </div>
